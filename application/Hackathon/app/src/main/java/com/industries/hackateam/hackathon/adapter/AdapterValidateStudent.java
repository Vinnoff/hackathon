...
public class AdapterValidateStudent extends BaseAdapter
{
    Context context;
    String[] values;
    ...
    public AdapterValidateStudent(Context context, String[] listValue)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View vi = view;
        if (vi == null)
            vi = inflater.inflate(R.layout.response_cell_simpletext, null);
